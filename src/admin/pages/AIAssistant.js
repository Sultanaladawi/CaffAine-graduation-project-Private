  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (error.code === 'ECONNABORTED') {
        setMessages(prev => [...prev, { id: Date.now()+1, type: 'bot', text: "ط¹ط°ط±ط§ظ‹طŒ ط§ظ„ط³ظٹط±ظپط± ظ…ط´ط؛ظˆظ„ ط­ط§ظ„ظٹط§ظ‹ ط¨طھط­ظ„ظٹظ„ ظƒظ…ظٹط© ط¨ظٹط§ظ†ط§طھ ط¶ط®ظ…ط©طŒ ظٹط±ط¬ظ‰ ط§ظ„ظ…ط­ط§ظˆظ„ط© ط¨ط¹ط¯ ظ‚ظ„ظٹظ„." }]);
      } else {
